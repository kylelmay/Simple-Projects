...
// Gets the network increment, network bits, and host bits using the subnet mask. ----------------------------------------------- [GOOD] 
...
// Gets IP, subnetQty, and hostQty from user and validates them for legal values. ----------------------------------------------- [GOOD]
...
//Separates user ip string into integer octets then calculates octet values in binary ------------------------------------------- [GOOD]
...
// Prints out basic information for NetworkID Octets ---------------------------------------------------------------------------- [GOOD]
...
// Prints out subnets, associated IP addresses, and network information to the user --------------------------------------------- [GOOD]
...
//Separates subnet mask into decimal integer values then calculates octet values in binary -------------------------------------- [GOOD]
...
// Find subnets and host information based on requirements for hosts and networks ----------------------------------------------- [GOOD]
...
// Initializes class value based on octet1 -------------------------------------------------------------------------------------- [GOOD]
